...
import io.github.zemelua.umu_client.renderer.world.FallingStarsRenderer;
...
public class ClientHandler {
	...
	public static final FallingStarsRenderer FALLING_STAR_RENDERER = new FallingStarsRenderer(Minecraft.getInstance());
