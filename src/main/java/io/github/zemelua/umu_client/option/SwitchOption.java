...
public class SwitchOption extends AbstractOption<Boolean> {
	public SwitchOption(Boolean defaultValue, Function<ModConfig, ForgeConfigSpec.ConfigValue<Boolean>> cache,
	...
	public static class Builder {
		...
		public SwitchOption build(Function<ModConfig, ForgeConfigSpec.ConfigValue<Boolean>> cache) {
