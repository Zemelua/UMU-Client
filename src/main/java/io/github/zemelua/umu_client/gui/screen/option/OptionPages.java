		...
		SOUND = ImmutableList.<Page>builder()
				.add(new Page.Builder()
						.add(new Group.Builder()
								...
								.add(VanillaOptions.MUSIC_VOLUME).build()
						).add(new Group.Builder()
								.add(VanillaOptions.VOICE_VOLUME).build()
						).build("sound.general")
				).add(new Page.Builder()
						.add(new Group.Builder()
								.add(VanillaOptions.BLOCKS_VOLUME).build()
						).add(new Group.Builder()
								.add(ModOptions.BLOCKS_PLACE_VOLUME)
								.add(ModOptions.BLOCKS_BREAK_VOLUME).build()
						).add(new Group.Builder()
								.add(VanillaOptions.RECORDS_VOLUME).build()
						).build("sound.blocks")
				).add(new Page.Builder()
						.add(new Group.Builder()
								.add(VanillaOptions.PLAYERS_VOLUME).build()
						).build("sound.players")
				).add(new Page.Builder()
						.add(new Group.Builder()
								.add(VanillaOptions.HOSTILE_VOLUME).build()
						).add(new Group.Builder()
								.add(VanillaOptions.NEUTRAL_VOLUME).build()
						).build("sound.entities")
				).add(new Page.Builder()
						.add(new Group.Builder()
								.add(VanillaOptions.WEATHER_VOLUME).build()
						).add(new Group.Builder()
								.add(VanillaOptions.AMBIENT_VOLUME).build()
